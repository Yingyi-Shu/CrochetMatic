...
static const unsigned int Needle_Stepper_Direction = 1;
static const int16_t Latch_Stepper_Initial_Value = 00;
static const unsigned int FTM2_MOD_VALUE = 0xFFFF;
static const unsigned int Latch_Stepper_Direction = 1;
...
int32_t needle_stepper_position()
{
  ...
  return((int32_t)(Needle_Stepper_Direction*value) + needle_stepper_base_value);
}
...
int32_t latch_stepper_position()
{
  ...
  return((int32_t)(Latch_Stepper_Direction*value + latch_stepper_base_value));
}
